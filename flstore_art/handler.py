...
def main(req):
    ...
    print("-----")
    summed = [model_parameters[0][x].data.clone() for x in range(len(model_parameters[0]))]
    ...
    print(f"Total processing cost: {processing_time*cost_per_hour/3600}",  flush=True)
